...
export const WrenchScrewdriverIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.528-1.036.94-2.19.992-3.356a4.5 4.5 0 00-7.528-4.136c-1.186.878-2.227 1.96-2.843 3.195-.499 1.026-1.012 2.108-1.428 3.235-.453 1.144-.453 2.443 0 3.587.453 1.144 1.012 2.218 1.58 3.295.572 1.087 1.262 2.062 2.064 2.923.806.867 1.838 1.592 2.944 2.097 1.11.505 2.34.505 3.456 0 .403-.183.784-.403 1.133-.668l-3.56-3.56-2.496 3.03z" /></svg>
);
...
export const PlayIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.348a1.125 1.125 0 010 1.972l-11.54 6.347a1.125 1.125 0 01-1.667-.986V5.653z" /></svg>
);
...
export const ArrowTopRightOnSquareIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" /></svg>
);
...
export const TvIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M6 20.25h12m-7.5-3.75v3.75m-3.75 0h10.5a2.25 2.25 0 002.25-2.25V6.75a2.25 2.25 0 00-2.25-2.25H6.75A2.25 2.25 0 004.5 6.75v10.5a2.25 2.25 0 002.25 2.25z" /></svg>
);
...
export const UsersIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.663M12 3.375c-1.621 0-2.924.63-3.958 1.588A5.844 5.844 0 005.122 8.25c0 3.235 2.618 5.858 5.858 5.858a5.844 5.844 0 004.478-2.076 5.844 5.844 0 00-.756-3.958A5.844 5.844 0 0012 3.375z" /></svg>
);

export const UserGroupIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.952a4.5 4.5 0 015.636 0M14.25 5.25a3 3 0 01-3 3m-3-3a3 3 0 00-3 3m-3.75 5.25a3 3 0 013-3m3 3a3 3 0 01-3-3m-1.5-3a3 3 0 00-3 3m-3.75 2.25a3 3 0 013-3m3 3a3 3 0 01-3-3M3.375 19.5a3 3 0 013-3m3 3a3 3 0 01-3-3m5.25 3a3 3 0 013-3m3 3a3 3 0 01-3-3m-3-3a3 3 0 00-3 3" /></svg>
);
...
export const MapIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-6v8.25m.5-11.62l-4.5-1.5-4.5 1.5m14.25 5.25l-4.5 1.5-4.5-1.5m4.5 1.5l-4.5 1.5-4.5-1.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
);

export const LifebuoyIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 110-18 9 9 0 010 18zm0 0a8.956 8.956 0 002.04-1.42 8.948 8.948 0 001.42-2.04M12 21a8.956 8.956 0 01-2.04-1.42 8.948 8.948 0 01-1.42-2.04M12 21a8.956 8.956 0 00-2.04 1.42 8.948 8.948 0 00-1.42 2.04M12 3a8.956 8.956 0 012.04 1.42 8.948 8.948 0 011.42 2.04M12 3a8.956 8.956 0 00-2.04 1.42 8.948 8.948 0 00-1.42 2.04M12 3v18m9-9h-18" /></svg>
);
...
export const Cog6ToothIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-.962a8.958 8.958 0 017.303 3.94M3.194 15.031c.996.096 2.016.223 3.032.428a3.75 3.75 0 01.708 6.864c.238.192.497.37.76.54H3.194a2.25 2.25 0 01-2.25-2.25v-4.5a2.25 2.25 0 012.25-2.25zM19.066 9.34c.24.464.46.93.655 1.41a3.75 3.75 0 01-2.924 5.235c-.39.043-.784.075-1.18.1a3.758 3.758 0 01-3.66-2.572V9.34a3.75 3.75 0 014.11-4.113.75.75 0 00.514-1.298A8.958 8.958 0 009.594 3.94M4.5 9.34a3.75 3.75 0 015.234-2.925.75.75 0 001.298-.514A8.958 8.958 0 003.94 9.594M19.066 9.34L19.5 9.594a8.958 8.958 0 01-3.94 7.303.75.75 0 00-1.298.514 3.75 3.75 0 01-5.235 2.924" /></svg>
);
...
export const BuildingLibraryIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V5.63c0-.621-.504-1.125-1.125-1.125a48.114 48.114 0 00-3.5-1.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
);
